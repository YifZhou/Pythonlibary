...
def makeGaussian(size, sigma):
    ...
    rv = multivariate_normal(
        mean=[size / 2, size / 2], cov=[[sigma, 0], [0, sigma]])
        ...
        for k in range(n_nans):
            ...
            for I in range(kernel_size):
                for J in range(kernel_size):
                    ...
                    if i + I - kernel_radius < array.shape[
                            0] and i + I - kernel_radius >= 0:
                        if j + J - kernel_radius < array.shape[
                                1] and j + J - kernel_radius >= 0:

                            # if the neighbour element is not NaN itself.
                            if filled[i + I - kernel_radius, j + J -
                                      kernel_radius] == filled[
                                          i + I - kernel_radius, j + J -
                                          kernel_radius]:
                                ...
                                if I - kernel_radius != 0 and J - kernel_radius != 0:
                                    ...
                                    filled[i, j] = filled[i, j] + filled[
                                        i + I - kernel_radius, j + J -
                                        kernel_radius] * kernel[I, J]
                                    n = n + 1 * kernel[I, J]
